...
class UILabelX: UILabel {
  ...
  @IBInspectable var angle: CGFloat = 2.5
    @IBInspectable var maxArc: CGFloat = 1.7
    @IBInspectable var maxWidthPerLine: CGFloat = 145.0
    @IBInspectable var clockwise: Bool = true
    @IBInspectable var lines : [String] = [String]()
