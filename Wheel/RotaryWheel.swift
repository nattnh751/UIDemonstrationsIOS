...
class RotaryWheel: UIControl,KCRotaryWheelProt {
  var delegate :RotaryWheelProtocol? = nil;
  ...
  func drawWheel() ->() {
    ...
    var widthOfImageView: CGFloat = RotaryWheel.widthOfImageViewPad;
    var widthOfBackgroundViewItem: CGFloat = RotaryWheel.widthOfBackgroundViewItemPad;
    var constantForRotatedImage: CGFloat = RotaryWheel.constantForRotatedImagePad;
    ...
    if (UIDevice.current.userInterfaceIdiom == .phone){
      widthOfImageView = RotaryWheel.widthOfImageViewPhone;
      widthOfBackgroundViewItem = RotaryWheel.widthOfBackgroundViewItemPhone;
      constantForRotatedImage = RotaryWheel.constantForRotatedImagePhone;
      constantForLabelWH = constantForLabelWH/1.6;
      constantForLabelY = constantForLabelY/1.6;
      constantForLabelX = constantForLabelX/1.6;
      constantForMaxWidthPerLine = constantForMaxWidthPerLine*2.6
      fontSize = 11.0;
    }
...
//      (sectors?.object(at: hiddenSector!) as! KCSector).categoryId = cat.categoryId as! CGFloat;
  ...
  func touchHappenedForPhone(_ rad: CGFloat) {
    let konecranesRed = UIColor(named: "#f71c1c");
